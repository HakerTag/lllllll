...
public final class UByte implements Comparable<UByte> {
    ...
    private static final int m40plusxj2QHRw(byte b, short s) {
        return UInt.m88constructorimpl(UInt.m88constructorimpl(b & MAX_VALUE) + UInt.m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final int m26divxj2QHRw(byte b, short s) {
        return UnsignedKt.m314uintDivideJ1ME1BU(UInt.m88constructorimpl(b & MAX_VALUE), UInt.m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final int m45remxj2QHRw(byte b, short s) {
        return UnsignedKt.m315uintRemainderJ1ME1BU(UInt.m88constructorimpl(b & MAX_VALUE), UInt.m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final byte m31invimpl(byte b) {
        return m21constructorimpl((byte) (~b));
    }
