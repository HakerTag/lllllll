...
public final class TestClock extends AbstractLongClock {
    ...
    public final void m975plusAssignLRDsOJo(double d) {
        long j;
        double r0 = Duration.m960toDoubleimpl(d, getUnit());
        long j2 = (long) r0;
    ...
    private final void m974overflowLRDsOJo(double d) {
        throw new IllegalStateException("TestClock will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m966toStringimpl(d) + '.');
    }
}
