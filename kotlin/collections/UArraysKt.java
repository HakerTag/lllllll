...
public final class UArraysKt {
    ...
    public static final int m346random2D5oskM(int[] iArr, Random random) {
    ...
    public static final long m347randomJzugnMA(long[] jArr, Random random) {
    ...
    public static final byte m348randomoSF2wD8(byte[] bArr, Random random) {
    ...
    public static final short m349randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m306isEmptyimpl(sArr)) {
            return UShortArray.m303getimpl(sArr, random.nextInt(UShortArray.m304getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m334contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m337contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m335contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m336contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m338contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m340contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m339contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m341contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m342contentToStringajY9A(int[] iArr) {
    ...
    public static final String m344contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m343contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m345contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m350toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m140getSizeimpl(iArr);
    ...
    public static final ULong[] m352toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m209getSizeimpl(jArr);
    ...
    public static final UByte[] m351toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m71getSizeimpl(bArr);
    ...
    public static final UShort[] m353toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m304getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m248boximpl(UShortArray.m303getimpl(sArr, i));
        }
        return uShortArr;
    }
}
