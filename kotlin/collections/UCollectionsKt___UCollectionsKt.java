...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m64constructorimpl(collection.size());
        int i = 0;
        for (UByte uByte : collection) {
            UByteArray.m75setVurrAj0(r0, i, uByte.m62unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m133constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m144setVXSXFK8(r0, i, uInt.m131unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m202constructorimpl(collection.size());
        int i = 0;
        for (ULong uLong : collection) {
            ULongArray.m213setk8EXiF4(r0, i, uLong.m200unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m297constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m308set01HTLdE(r0, i, uShort.m295unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m88constructorimpl(i + uInt.m131unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j = ULong.m157constructorimpl(j + uLong.m200unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m88constructorimpl(i + UInt.m88constructorimpl(uByte.m62unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m88constructorimpl(i + UInt.m88constructorimpl(uShort.m295unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
