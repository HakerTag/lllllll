...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public boolean m376contains7apg3OU(byte b) {
        return UByteArray.m66contains7apg3OU(this.$this_asList, b);
    }

    @Override // java.util.List, kotlin.collections.AbstractList
    public UByte get(int i) {
        return UByte.m15boximpl(UByteArray.m70getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-7apg3OU  reason: not valid java name */
    public int m377indexOf7apg3OU(byte b) {
        return ArraysKt.indexOf(this.$this_asList, b);
    }

    /* renamed from: lastIndexOf-7apg3OU  reason: not valid java name */
    public int m378lastIndexOf7apg3OU(byte b) {
