...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public boolean m373containsVKZWuLQ(long j) {
        return ULongArray.m204containsVKZWuLQ(this.$this_asList, j);
    }

    @Override // java.util.List, kotlin.collections.AbstractList
    public ULong get(int i) {
        return ULong.m151boximpl(ULongArray.m208getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-VKZWuLQ  reason: not valid java name */
    public int m374indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ  reason: not valid java name */
    public int m375lastIndexOfVKZWuLQ(long j) {
