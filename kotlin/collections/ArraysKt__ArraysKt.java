                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m421contentEqualsus8wMrg(t.m217unboximpl(), t2.m217unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m418contentEqualsctEhBpI(t.m148unboximpl(), t2.m148unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m420contentEqualsmazbYpA(t.m312unboximpl(), t2.m312unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m419contentEqualskdPth3s(t.m79unboximpl(), t2.m79unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m427contentToStringGBYM_sE(t.m79unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m429contentToStringrL5Bavg(t.m312unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m426contentToStringajY9A(t.m148unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m428contentToStringQwZRm1k(t.m217unboximpl()));
            } else {
