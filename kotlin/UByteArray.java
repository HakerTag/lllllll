...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static byte[] m65constructorimpl(byte[] bArr) {
    ...
    public static final boolean m69equalsimpl0(byte[] bArr, byte[] bArr2) {
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m64constructorimpl(int i) {
        return m65constructorimpl(new byte[i]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final byte m70getimpl(byte[] bArr, int i) {
        return UByte.m21constructorimpl(bArr[i]);
    }

    /* renamed from: set-VurrAj0  reason: not valid java name */
    public static final void m75setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m71getSizeimpl(byte[] bArr) {
        return bArr.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static UByteIterator m74iteratorimpl(byte[] bArr) {
    ...
    /* renamed from: contains-7apg3OU  reason: not valid java name */
    public static boolean m66contains7apg3OU(byte[] bArr, byte b) {
        return ArraysKt.contains(bArr, b);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m67containsAllimpl(byte[] bArr, Collection<UByte> collection) {
        boolean z;
        Intrinsics.checkParameterIsNotNull(collection, "elements");
        Collection<UByte> collection2 = collection;
        if (!collection2.isEmpty()) {
            for (T t : collection2) {
                if (!(t instanceof UByte) || !ArraysKt.contains(bArr, t.m62unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
    ...
    public static boolean m73isEmptyimpl(byte[] bArr) {
