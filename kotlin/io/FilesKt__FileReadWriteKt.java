...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r9) {
        /*
            ...
            r3 = 0
            long r4 = r9.length()     // Catch:{ all -> 0x0064 }
            r6 = 2147483647(0x7fffffff, float:NaN)
            long r6 = (long) r6     // Catch:{ all -> 0x0064 }
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 > 0) goto L_0x003e
            int r9 = (int) r4     // Catch:{ all -> 0x0064 }
            byte[] r4 = new byte[r9]     // Catch:{ all -> 0x0064 }
        L_0x0022:
            if (r9 <= 0) goto L_0x002e
            int r5 = r2.read(r4, r3, r9)     // Catch:{ all -> 0x0064 }
        ...
        L_0x002e:
            ...
            goto L_0x003a
        L_0x0031:
            byte[] r4 = java.util.Arrays.copyOf(r4, r3)     // Catch:{ all -> 0x0064 }
            java.lang.String r9 = "java.util.Arrays.copyOf(this, newSize)"
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r4, r9)     // Catch:{ all -> 0x0064 }
        L_0x003a:
