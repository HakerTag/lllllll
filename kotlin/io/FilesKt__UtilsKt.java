...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final java.io.File copyTo(java.io.File r6, java.io.File r7, boolean r8, int r9) {
        ...
        L_0x004f:
            ...
            r1 = r8
            java.io.FileInputStream r1 = (java.io.FileInputStream) r1     // Catch:{ all -> 0x007e }
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ all -> 0x007e }
            r2.<init>(r7)     // Catch:{ all -> 0x007e }
            java.io.Closeable r2 = (java.io.Closeable) r2     // Catch:{ all -> 0x007e }
            java.lang.Throwable r6 = (java.lang.Throwable) r6     // Catch:{ all -> 0x007e }
            r3 = r2
            java.io.FileOutputStream r3 = (java.io.FileOutputStream) r3     // Catch:{ all -> 0x0077 }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x0077 }
            java.io.OutputStream r3 = (java.io.OutputStream) r3     // Catch:{ all -> 0x0077 }
            kotlin.io.ByteStreamsKt.copyTo(r1, r3, r9)     // Catch:{ all -> 0x0077 }
            kotlin.io.CloseableKt.closeFinally(r2, r6)
