...
public final class UInt implements Comparable<UInt> {
    ...
    private static final int m87compareToxj2QHRw(int i, short s) {
        return UnsignedKt.uintCompare(i, m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final int m107plusxj2QHRw(int i, short s) {
        return m88constructorimpl(i + m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final int m93divxj2QHRw(int i, short s) {
        return UnsignedKt.m314uintDivideJ1ME1BU(i, m88constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final int m112remxj2QHRw(int i, short s) {
        return UnsignedKt.m315uintRemainderJ1ME1BU(i, m88constructorimpl(s & UShort.MAX_VALUE));
    }
