...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static long[] m203constructorimpl(long[] jArr) {
    ...
    public static final boolean m207equalsimpl0(long[] jArr, long[] jArr2) {
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m202constructorimpl(int i) {
        return m203constructorimpl(new long[i]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final long m208getimpl(long[] jArr, int i) {
        return ULong.m157constructorimpl(jArr[i]);
    }

    /* renamed from: set-k8EXiF4  reason: not valid java name */
    public static final void m213setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m209getSizeimpl(long[] jArr) {
        return jArr.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static ULongIterator m212iteratorimpl(long[] jArr) {
    ...
    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public static boolean m204containsVKZWuLQ(long[] jArr, long j) {
        return ArraysKt.contains(jArr, j);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m205containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkParameterIsNotNull(collection, "elements");
        Collection<ULong> collection2 = collection;
        if (!collection2.isEmpty()) {
            for (T t : collection2) {
                if (!(t instanceof ULong) || !ArraysKt.contains(jArr, t.m200unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
    ...
    public static boolean m211isEmptyimpl(long[] jArr) {
